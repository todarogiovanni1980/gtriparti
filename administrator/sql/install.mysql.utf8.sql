...
INSERT INTO `#__content_types` (`type_title`, `type_alias`, `table`, `content_history_options`)
SELECT * FROM ( SELECT 'Ricevuta','com_tgriparti.ricevuta','{"special":{"dbtable":"#__tgriparti_ricevuta","key":"id","type":"Ricevuta","prefix":"TgripartiTable"}}', '{"formFile":"administrator\/components\/com_tgriparti\/models\/forms\/ricevuta.xml", "hideFields":["checked_out","checked_out_time","params","language" ,"descrizione"], "ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time"], "convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"catid","targetTable":"#__categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"group_id","targetTable":"#__usergroups","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"#__viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"#__users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"condominio","targetTable":"#__tgriparti_condominio","targetColumn":"id","displayColumn":"via"}]}') AS tmp
WHERE NOT EXISTS (
