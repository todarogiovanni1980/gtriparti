...
$canCreate  = $user->authorise('core.create', 'com_tgriparti') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'condominioform.xml');
$canEdit    = $user->authorise('core.edit', 'com_tgriparti') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'condominioform.xml');
